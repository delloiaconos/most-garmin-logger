...
class RL_App extends App.AppBase {
  ...
  function initActivity() as Void {
    if($.RL_oActivitySession == null) {
      var oActivitySession = ActivityRecording.createSession({ :name => "MOSTLogger", :sport => ActivityRecording.SPORT_GENERIC, :subSport => ActivityRecording.SUB_SPORT_GENERIC });
